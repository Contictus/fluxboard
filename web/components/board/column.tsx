  ...
  return (
    <div className="flex w-72 shrink-0 flex-col rounded-lg bg-secondary/40">
      ...
      <div
        ref={setNodeRef}
        className={cn(
          'flex min-h-[3rem] flex-1 flex-col gap-2 px-2 pb-2 transition-colors',
          isOver && 'bg-primary/5',
        )}
      >
        ...
        {composing ? (
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-md px-2 py-1.5 text-left text-xs text-muted-foreground hover:bg-secondary hover:text-foreground"
          >
